...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Pencatatan Biaya Pengeluaran </h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="#">Home</a></li>
                    <li class="breadcrumb-item active">Pencatatan Biaya</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
                    ...
                    <div class="card-header border-0">
                        <div class="d-flex justify-content-between">
                            <button type="button" class="btn btn-primary" style="background-color:#483D8B;" data-toggle="modal" data-target="#exampleModal">
                                <i class="fas fa-plus-square"></i> Biaya Pengeluaran
                            </button>
                        </div>
                    </div>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <table id="tabeltoko" class="display table table-striped">
                            ...
                            <tbody >
                                @foreach($data_biaya as $no => $data)
                                <tr>
                                    <td>{{$no+1}}</td>
                                    <td>{{$data->nama_toko}}</td>
                                    <td>{{ date("d F Y", strtotime($data->tgl_trans))}}</td>
                                    <td>{{$data->catatan_trans}}</td>
                                    <td> Rp. {{ number_format( $data->biaya_trans)}}
                                    </td>
                                    <td>
                                        <a href="{{ route('edit.catat_biaya_pengeluaran', $data->id_trans) }}" class="btn btn-warning btn-sm btn-circle"><i class="far fa-edit"></i></a>
                                        <button type="button" class="btn btn-danger btn-sm btn-circle" onclick="ModalHapus(' {{ route('delete.catat_biaya_pengeluaran', $data->id_trans) }} ')"><i class="fas fa-trash"></i></button>
                                    </td>
                                </tr>
                                @endforeach
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('simpan.catat_biaya_pengeluaran')}}" method="POST">
                    @csrf
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-12">
                                <label for="">Tanggal Pencatatan Omset</label>
                                <label for="" style="color:red;"><i>*</i></label>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-12">
                                <label for="">Jumlah Biaya Keluar (Rp.)</label>
                                <label for="" style="color:red;"><i>*</i></label>
