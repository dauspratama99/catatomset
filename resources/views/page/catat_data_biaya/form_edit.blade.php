...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Edit Data Biaya Pengeluaran</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <script>
                                            document.getElementById('id_trans_toko').value="{{$data_trans->id_trans_toko}}"
                                        </script>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <input type="text" class="form-control" name="catatan_trans" value="{{ old('catatan_trans') ?? ($data_trans->catatan_trans ?? '') }}">
                                </div>
                            </div>
