...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Laporan Omset Penjualan</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-2 pt-2 mb-2">
                                        <div class="col-auto my-4 pr-6">
                                            <button type="button" class="btn" onclick="cetakomset()" style="background-color:  #483D8B; color:white;"><i class="fas fa-print"></i> Cetak</button>
                                        </div>
                                    </div>
...
<script>
    ...
    function caridata() {
        ...
        $('#isidata').load("/laporan_data_omset/" + cabang + "/" + dari + "/" + sampai)
    }
    ...
    function cetakomset()
    {
        ...
        window.open(`{{ url('tampil_cetak_pdf') }}/`+ cabang + "/" + dari + "/" + sampai, '_blank' );
    }
